...
namespace RavaSync.API.Data.Extensions;
...
public static class UserPermissionsExtensions
{
    ...
    public static bool IsDisableCustomizePlus(this UserPermissions perm)
    {
        return perm.HasFlag(UserPermissions.DisableCustomizePlus);
    }
    public static bool IsDisableMetaData(this UserPermissions perm)
    {
        return perm.HasFlag(UserPermissions.DisableMetaData);
    }
    ...
    public static void SetDisableCustomizePlus(this ref UserPermissions perm, bool set)
    {
        if (set) perm |= UserPermissions.DisableCustomizePlus;
        else perm &= ~UserPermissions.DisableCustomizePlus;
    }

    public static void SetDisableMetaData(this ref UserPermissions perm, bool set)
    {
        if (set) perm |= UserPermissions.DisableMetaData;
        else perm &= ~UserPermissions.DisableMetaData;
    }
