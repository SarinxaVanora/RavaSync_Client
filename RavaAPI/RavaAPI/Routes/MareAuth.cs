...
public class MareAuth
{
    ...
    public const string Auth_CreateClientSecret = "createClientSecret";
    ...
    public static Uri CreateClientSecretFullPath(Uri baseUri) => new Uri(baseUri, Auth + "/" + Auth_CreateClientSecret);
}