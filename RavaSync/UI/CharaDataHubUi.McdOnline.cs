...
internal sealed partial class CharaDataHubUi
{
    ...
    {
        _uiSharedService.BigText("RavaSync Character Data Online");

        DrawHelpFoldout("In this tab you can create, view and edit your own RavaSync Character Data that is stored on the server." + Environment.NewLine + Environment.NewLine
