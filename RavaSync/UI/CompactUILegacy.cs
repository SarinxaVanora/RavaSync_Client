...
public class CompactUiLegacy : WindowMediatorSubscriberBase
{
    ...
    private readonly TopTabMenuLegacy _tabMenu;
    ...
    public CompactUiLegacy(ILogger<CompactUiLegacy> logger, UiSharedService uiShared, MareConfigService configService, ApiController apiController, PairManager pairManager,
        ...
        : base(logger, mediator, "###RavaSyncMainUI", performanceCollectorService)
    {
        ...
        _tabMenu = new TopTabMenuLegacy(Mediator, _apiController, _pairManager, _uiSharedService);
