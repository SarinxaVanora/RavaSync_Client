...
public class CensusPopupHandler : IPopupHandler
{
    ...
    public void DrawContent()
    {
        ...
        {
            start = ImGui.GetCursorPosY() - ImGui.CalcTextSize("RavaSync Census Data").Y;
            UiSharedService.TextWrapped("RavaSync Census Participation");
        }
        ImGuiHelpers.ScaledDummy(5f);
        UiSharedService.TextWrapped("If you are seeing this popup you are updating from a RavaSync version that did not collect census data. Please read the following carefully.");
        ImGui.Separator();
        UiSharedService.TextWrapped("RavaSync Census is a data collecting service that can be used for statistical purposes. " +
        ...
        UiSharedService.TextWrapped("If enabled, RavaSync Census will collect following data:" + Environment.NewLine
        ...
        UiSharedService.TextWrapped("This setting can be changed anytime in the RavaSync Settings.");
