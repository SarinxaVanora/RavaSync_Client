...
{
    //private const int _defaultBufferSize = 4096; 4 Kib upload buffer - original setting
    //private const int _defaultBufferSize = 131072; // 128 KiB default
    private const int _defaultBufferSize = 1048576; // 1 MiB default
